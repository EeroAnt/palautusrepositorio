...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahta_eri_tuotetta_ostettaessa_tilisiirtoa_kutsutaan_oikeilla_asiakkaalla_tilinumerolla_ja_summalla(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kahta_samaa_tuotetta_ostettaessa_tilisiirtoa_kutsutaan_oikeilla_asiakkaalla_tilinumerolla_ja_summalla(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
    ...
    def test_ostettaessa_tuotteita_joista_osa_loppu_tilisiirtoa_kutsutaan_oikeilla_asiakkaalla_tilinumerolla_ja_summalla(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_poista_korista_metodi_palauttaa_tuotteen_varastoon(self):
        ...
        self.varasto_mock.palauta_varastoon.assert_called_with(Tuote(2, "kahvi", 7))
    
    def test_poista_korista_metodi_ei_palauta_tuotetta_varastoon_jota_ei_ole_ostoskorissa(self):
        # tehdään ostoksia
        self.kauppa.aloita_asiointi()
        self.kauppa.poista_korista(2)

        # varmistetaan, että varaston metodia palauta_varastoon ei ole kutsuttu
